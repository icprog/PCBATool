...
/*Mode **/
#define NODE_CP					0
#define NODE_RSNODE				1
#define	NODE_RKD				2
#define NODE_AT					3
#define MAX_CP_NODE				4
...
#define DEVTYPE_SOFIA3GR        0
#define DEVTYPE_XMM6321         1
#define DEVTYPE_WIFIONLY        2
#define DEVTYPE_AUTO            3
...
public:
	...
	//ldq
	bool GetHello(std::string &output);
	bool StartTest(std::string &output);
	bool QueryStatus(std::string &output);
	bool EndTest();
private:
    bool rebootxmm6321();
